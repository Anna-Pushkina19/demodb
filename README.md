...
Чтобы создать SQL-скрипт, в каталоге репозитория операционной системы выполните команду:
...
> **Примечание**
> Чем меньше значение, тем больше рейсов доступно для формирования маршрута и выше риск опоздать на стыковочный рейс при задержке предыдущего.
...
> **Примечание**
> Чем больше значение, тем больше рейсов доступно для формирования маршрута и длиннее время ожидания следующего рейса. Слишком большое значение будет неправдоподобным.
